...
module.exports.execute = async(client , message, args) => {    
      ...
      let tagli = message.guild.members.cache.filter(uye => uye.user.username.includes(config.guild.tag)).size;
    ...
    handler.mesaj("true", message.author, message.channel, `**>** Anlık olarak **${sesli}** (**+${artikac}**) kişi ses kanallarında aktif!
